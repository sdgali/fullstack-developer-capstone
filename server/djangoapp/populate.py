...
def initiate():
    ...
    for data in car_make_data:
        ...
        car_make_instances.append(CarMake.objects.create(name=name, description=description))
    ...
    for data in car_model_data:
        ...
        type = data['type']
        year = data['year']
        CarModel.objects.create(name=name, car_make=car_make, type=type, year=year)
